...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* ── LIGHT MODE: Warm split layout ──────────────────────────────────────── */}
      {/* ── DARK MODE: Full dark with glow ─────────────────────────────────────── */}
      ...
      <div className="hidden lg:flex w-1/2 bg-primary-600 dark:bg-dl-dark-s2 items-center justify-center p-12">
        <div className="text-white dark:text-dl-dt space-y-4 max-w-xs">
          ...
          <h1 className="text-4xl font-extrabold leading-tight">Know what's wrong before you repair.</h1>
          <p className="text-white/70 dark:text-dl-dt2 text-sm leading-relaxed">
            Snap a photo of any broken device and get instant AI-powered repair advice, cost estimates, and local shop recommendations.
          </p>
        </div>
      </div>
        ...
        <div className="relative z-10 w-full max-w-sm space-y-8">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-dl-dt2 mt-1">Sign in to save your scan history</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="
                ...
                bg-white dark:bg-dl-dark-s2
                border border-gray-200 dark:border-dl-dark-b
                rounded-xl shadow-soft hover:shadow-card dark:hover:border-accent/30
                text-gray-800 dark:text-dl-dt font-semibold text-sm
            ...
            <button
              onClick={() => {
                // Guest mode — redirect to app (AppProvider handles guest)
                window.location.href = window.location.origin + '?guest=1';
              }}
              className="
                w-full h-12 flex items-center justify-center
                text-gray-500 dark:text-dl-dt2 text-sm font-medium
                hover:text-gray-700 dark:hover:text-dl-dt transition-colors
              "
            >
          ...
          <p className="text-center text-[11px] text-gray-400 dark:text-dl-dt2 leading-relaxed">
            By signing in you agree to our Terms of Service. Your photos are never stored permanently without your consent.
          </p>
        </div>
      </div>
    </div>
